...
One page per topic; the [tour](../TOUR.md) is the short version. Every
screenshot is a headless capture with the real dictionaries installed,
German as the preferred language, dark theme unless said otherwise.

- [Search](search.md): what a query can be, tags, quotes and wildcards, inflected forms, sentences, names, JLPT, no results, back
...
- [Keyboard shortcuts](shortcuts.md): every key
